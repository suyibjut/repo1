...
test_data_name = 'design2code'


tokenizer_path = '/models/vicuna-7b-v1.5'
model_path = f'/projects/vision2ui/models/{model_name}'
result_path = f'/projects/vision2ui/results/{model_name}-{test_data_name}'
data_path = f'/projects/vision2ui/datasets/{test_data_name}_benchmark'
...
for item in tqdm(ds):
    ...
    save_result(save_path, image, item['text'], html, duration)
