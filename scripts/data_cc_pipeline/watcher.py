...
def main():
    ...
    parser.add_argument('directory', nargs='?', default='/xx/xx/xx/code/UICoder/datasets/cc-wash/H128-2560_C128-4096_R2/c4-format', help='Directory path')
    parser.add_argument('-i', '--interval', type=int, default=2, help='Interval in seconds for counting')
    parser.add_argument('-l', '--log-file', default='/xx/xx/xx/code/UICoder/outputs/watcher.log', help='Path to the log file')
