...
batch_size = 128
chunk_idx = '15'
path = f'/xx/xx/xx/code/UICoder/datasets/c4-wash/chunks/chunk{chunk_idx}-format-parquet'
ckpt = '/xx/xx/xx/code/UICoder/checkpoints/classifier/c4_500.pth'
output_path = f'/xx/xx/xx/code/UICoder/datasets/c4-wash/scored-chunks/chunk{chunk_idx}-format-scored-parquet'
