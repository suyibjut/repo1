...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", "-i", type=str, default="/xx/xx/xx/code/UICoder/datasets/c4-wash/H128-2560_C128-4096_R2/c4-chunk05-format-scored-parquet") # 0-100
    parser.add_argument("--processor_path", "-p", type=str, default="/models/pix2struct-large/") # 0-900
