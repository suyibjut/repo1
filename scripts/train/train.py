...
class MyTrainingArguments():
    ...
    model_name_or_path: str = field(default='/models/pix2struct-large/')
    batch_size: int = field(default=1)
    output_path: str = field(default='/xx/xx/xx/code/UICoder/checkpoints/')
...
class MyDataArguments():
    ...
    path: str = field(default='/xx/xx/xx/code/UICoder/datasets/WebSight-format-parquet')
