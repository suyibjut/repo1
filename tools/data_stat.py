...
def vision2ui():
    ...
    ds0 = load_from_disk('/xx/xx/datasets/cc/arrows_8-14_processed')
    df0_hashes = pd.read_csv("/xx/xx/datasets/cc/8-14_hash.csv")
    ds0 = ds0.add_column('hash', list(df0_hashes['hash']))
    ds1 = load_from_disk('/xx/xx/datasets/cc/train_arrows_5-8_15')
